...
export default function UserDropdown() {
  ...
  if (!isAuthenticated || !user) {
    return (
      <Link
        to="/signin"
        className="flex items-center gap-2 px-3 py-2 font-medium text-gray-700 rounded-lg text-theme-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
      >
        로그인
      </Link>
    );
