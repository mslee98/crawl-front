/**
 * 헤더 사용자 메뉴 (UserDropdown)
 * - 로그인 안 됨: "로그인" 링크 → /signin
 * - 로그인 됨: DiceBear 프로필 이미지 + 닉네임, 클릭 시 드롭다운 (프로필/설정/지원, 로그아웃)
 * - 로그아웃 시 useAuth().logout() 호출 (서버 무효화 + 로컬 상태 초기화)
 */
...
export default function UserDropdown() {
  ...
  /* 비로그인 시 앱 헤더에 로그인 아이콘만 표시 (다크모드/알림 버튼과 동일 스타일) */
